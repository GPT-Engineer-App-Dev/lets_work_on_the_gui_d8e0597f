    ...
    <Container maxW="container.xl" p={5}>
      <VStack spacing={5}>
        ...
        <Flex w="full" wrap="wrap" gap={10}>
          {/* Main Chat Interface */}
          <Box w={{ base: "full", md: "65%" }} p={5} borderWidth="2px" borderColor="brand.700" borderRadius="lg">
            <VStack spacing={4}>
          ...
          <VStack w={{ base: "full", md: "35%" }} spacing={4} align="stretch">
            <Box w="full" h="250px" borderWidth="1px" borderRadius="lg" overflow="hidden" bg="gray.200">
